...
public class PoolingManager
{
    ...
    public PoolingManager(string prefabPath, GameObject parent, int poolSize = DefaultPoolSize) //추가함
    {
        GameObject prefab = Resources.Load<GameObject>(prefabPath);
    ...
    public PoolingManager(GameObject prefab, GameObject parent, int poolSize = DefaultPoolSize) //추가함
    {
        _pooledObjects = new List<GameObject>(poolSize);
